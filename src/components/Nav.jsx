    ...
    >
      ...
      >
        <img
          ...
          width="25px"
          style={
            simple || solid || scrolled ? { filter: "invert(1)" } : undefined
          }
        />
        JFORM
      </div>
        ...
        <ul className="nav-links" id="nav-links">
          <li>
            <div
              ...
              style={
                simple
                  ? { background: "#f0f0f2", border: "1px solid #d0d0d5" }
                  : undefined
              }
            >
              <button
              ...
              <span
                className="sep"
                style={simple ? { color: "rgba(28,20,20,0.55)" } : undefined}
              >
                |
              </span>
              <button
          ...
          <ul className={`nav-links${menuOpen ? " open" : ""}`} id="nav-links">
            ...
            <li>
              ...
              >
                ...
                <span className="github-icon-mobile">github</span>
              </a>
            </li>
            <li>
              <div
              ...
              >
                ...
                <span
                  className="sep"
                  style={solid ? { color: "rgba(28,20,20,0.55)" } : undefined}
                >
                  |
                </span>
                <button
